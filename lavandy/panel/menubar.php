...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="catalogos-create-read.php">MIS CATÁLOGOS</a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="articulos-create-read.php">MIS PRODUCTOS</a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="pedidos_read.php">MIS PEDIDOS</a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="catalogos-comparte-read.php">VISTA PREVIA</a>
      </li>
    </ul>
