...
WHERE (((vista_traslados.ORIGEN_TDA)='$idtiendaup') 
  AND ((vista_traslados.STATUS_TRAS)=3))";
...
<div class="card ">
  <div class="card-header">
    <ul class="nav nav-tabs card-header-tabs">
      <li class="nav-item">
        <a class="nav-link " href="traslados_read_p.php">PENDIENTES</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="traslados_read_t.php">TRANSITO</a>
      </li>
      <li class="nav-item">
        <a class="nav-link active" href="traslados_read_f.php">FINALIZADO</a>
      </li>
    </ul>
  </div>
  <div class="card-body">
