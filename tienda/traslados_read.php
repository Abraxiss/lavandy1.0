...
<div class="card ">
  <div class="card-header">
    <ul class="nav nav-tabs card-header-tabs">
      ...
      <li class="nav-item">
        <a class="nav-link <?php echo $active3 ?>" href="traslados_read.php?s=3">FINALIZADOS</a>
      </li>
      <li class="nav-item">
        <a class="nav-link <?php echo $active4 ?>" href="traslados_read.php?s=4">ANULADOS</a>
      </li>
    </ul>
  </div>
  <div class="card-body">
