...
<table class="table table-striped table-sm">
  ...
  <tbody>
      ...
      <td><?php echo $filasD ['PRECIO_TOTAL']  ?> 
            ...
            <td> 
          <a onclick="return confirmLink()" href="crud_ordenes/item_delete.php?id=<?php echo $filasD ['ID_DETALLE']?>&io=<?php echo $ID_ORD ?>" class="btn btn-danger" > 
...
<table class="table table-sm ">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td> 
          <a onclick="return confirmLink()" href="crud_diario/delete_caja.php?d=<?php echo $filasDD ['ID_DIARIO'] ?>&o=<?php echo $ID_ORD?>" class="btn btn-danger" > 
          <span class="icon-bin"></span>
          </a> 
      </td>
    </tr>
