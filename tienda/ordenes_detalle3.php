...
<div class="container">
  ...
  <div class="card-footer text-muted">
    ...
    <button  type="button" class="btn btn-primary   btn-block" data-toggle="modal" data-target="#morden" >
    <span class="icon-price-tags"></span> MODIFICAR ORDEN
    </button>

    <button  type="button" class="btn btn-dark  btn-block" data-toggle="modal" data-target="#odetalle" >
...
<div class="container">
  ...
  <tbody>
   ...
   <div class="card-footer text-muted">
    ...
    <button  type="button" class="btn btn-success btn-block" data-toggle="modal" data-target="#iorden" >
   <span class=" icon-drawer"></span> &nbsp C A J A
    </button>

    <a type="button" class="btn btn-danger  btn-block" href="crud_ordenes/ord_delete.php?id=<?php echo $ID_ORD ?>">
